...
export const metadata: Metadata = {
  title: 'Merci — Demande de conception 3D reçue',
  description: 'Votre demande de conception 3D a bien été enregistrée.',
  robots: { index: false, follow: false },
};

export default function MerciRenovationTotale() {
  return (
    <>
      <Header />
